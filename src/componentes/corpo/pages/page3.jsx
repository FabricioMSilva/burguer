    ...
    <div className="fundo">
      ...
      <div className="pagina1 text-center px-4 mt-4">
        ...
        <div className="texto text-justify ">
          ...
          <br />
          <br />
          Tenha um cardápio com um Layout bonito, limpo, direto e claro, com
          foco nos lanches e principalmente enfatize o seu produto diferenciado.{" "}
          <br />
          <p>
            Evite uma grande variedade de opções pois assim você terá um estoque
            fácil de ser administrado evitando assim o desperdício, atendendo
            com maior rapidez.
          </p>
          <br />
          <p>
            Mostram que as Hamburgueria que oferecem delivery devem buscar 6
            opções por categoria de menu.
          </p>{" "}
          <br />
          <b>Ou seja:</b>
          <br />
          Tenha no seu cardápio no máximo até 8 opções de lanches. Por que essa
          limitação?
          <br />
          <br />
          Primeiro, o estudo revelou que a satisfação do cliente diminui à
          medida que o número de opções aumenta.
          <p>
            <br /> Isso é conhecido como “sobrecarga de escolha” e pode levar a
            examinar outros fatores como preço para tomar sua decisão.
          </p>{" "}
          <br />
        </div>
